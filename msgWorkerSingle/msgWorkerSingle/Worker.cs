...
namespace msgWorkerSingle
{
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    using SqlCommand command = new SqlCommand("MsgSendSingle", connection);
                    command.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        private async Task UpdateMessageStatusAsync(int logSingleMessage, int messageStatus)
        {
            ...
            {
                await connection.OpenAsync();
                using SqlCommand updateCommand = new SqlCommand("FinalStatusMsgSingle", connection);
